export function progressionQuestions(q) {
  return [
    ...
    q("CE2 : 1,5 est plus grand que :", ["2","1,8","1,4","3"], 2, "1,5 est plus grand que 1,4 mais plus petit que 1,8 et 2.", 2, ["ce2","maths","decimaux"]),
    ...
    q("CE2 : Choisis le bon accord.", ["Les fleurs rouge","Les fleurs rouges","Les fleur rouges","Les fleurs rougent"], 1, "'Fleurs' est féminin pluriel, donc 'rouges' prend un s.", 2, ["ce2","ortho","accord","pluriel"]),
    ...
    q("Lycée : Dans 'Bien qu'il soit tard, elle travaille', la subordonnée exprime :", ["La cause","La concession","La conséquence","Le but"], 1, "'Bien que' introduit une concession : une idée opposée à ce qu'on pourrait attendre.", 3, ["lycee","ortho","grammaire"]),
    ...
    q("CE2 : Comment appelle-t-on un paysan attaché à la terre d'un seigneur ?", ["Un serf","Un consul","Un député","Un pilote"], 0, "Au Moyen Âge, un serf dépendait d'un seigneur.", 2, ["ce2","histoire","moyen_age"]),
    ...
    q("CM2 : Napoléon Bonaparte a d'abord été :", ["Un astronaute","Un général","Un roi mérovingien","Un résistant"], 1, "Napoléon Bonaparte était un général avant de devenir Premier consul puis empereur.", 1, ["cm2","histoire","napoleon"]),
    q("CM2 : Les lois Jules Ferry concernent surtout :", ["L'école","Les trains","Les hôpitaux","Les ports"], 0, "Les lois Jules Ferry rendent l'école primaire gratuite, laïque et obligatoire.", 1, ["cm2","histoire","jules_ferry","republique"]),
    q("Collège : L'abolition définitive de l'esclavage en France date de :", ["1789","1815","1848","1905"], 2, "L'esclavage est aboli définitivement en France en 1848.", 2, ["college","histoire","esclavage","republique"]),
    q("Collège : La Première Guerre mondiale est aussi appelée :", ["La Grande Guerre","La Guerre froide","La guerre de Cent Ans","La guerre des Gaules"], 0, "La Première Guerre mondiale est souvent appelée la Grande Guerre.", 1, ["college","histoire","ww1"]),
    q("Collège : Le général de Gaulle appelle à continuer le combat le :", ["11 novembre 1918","18 juin 1940","8 mai 1945","14 juillet 1789"], 1, "L'appel du 18 juin 1940 invite les Français à poursuivre la résistance.", 2, ["college","histoire","ww2","resistance"]),
    q("Lycée : La Ve République renforce principalement :", ["Le rôle du président","Le pouvoir des seigneurs","Le pouvoir du clergé médiéval","Le retour de l'Empire"], 0, "La Constitution de 1958 donne un rôle important au président de la République.", 3, ["lycee","histoire","republique"]),
    ...
    q("CE1 : Quel drapeau est celui de la France ?", ["🇫🇷","🇮🇹","🇩🇪","🇪🇸"], 0, "Le drapeau français est bleu, blanc, rouge.", 1, ["ce1","geo","drapeaux","europe"]),
    ...
    q("CM1 : Un département français possède :", ["Un numéro","Une planète","Une étoile","Un alphabet"], 0, "Les départements français ont un numéro, comme 69 pour le Rhône.", 1, ["cm1","geo","departements"]),
    q("Collège : L'Union européenne est un ensemble :", ["De pays européens qui coopèrent","De continents","De fleuves français","De montagnes seulement"], 0, "L'Union européenne réunit des pays d'Europe qui coopèrent dans plusieurs domaines.", 2, ["college","geo","europe","monde"]),
    q("Collège : Quel océan sépare principalement l'Europe de l'Amérique ?", ["L'océan Indien","L'océan Atlantique","L'océan Pacifique","L'océan Arctique"], 1, "L'océan Atlantique se trouve entre l'Europe et l'Amérique.", 1, ["college","geo","mers","monde"]),
    q("Lycée : La mondialisation désigne surtout :", ["L'intensification des échanges à l'échelle mondiale","La disparition de toutes les frontières naturelles","La rotation de la Terre","La formation des montagnes"], 0, "La mondialisation correspond à l'intensification des flux de marchandises, capitaux, informations et personnes.", 3, ["lycee","geo","monde"]),
    ...
    q("Collège : Le poids d'un objet dépend principalement de :", ["Sa masse et la gravité","Sa couleur","Sa température seulement","Son âge"], 0, "Le poids dépend de la masse de l'objet et de l'intensité de la gravité.", 2, ["college","physique","mecanique"]),
    q("Collège : Une image dans un miroir plan est :", ["Symétrique par rapport au miroir","Toujours plus chaude","Toujours plus lourde","Toujours réelle et projetable"], 0, "Le miroir plan donne une image symétrique par rapport au plan du miroir.", 2, ["college","physique","optique"]),
    q("Lycée : Dans la relation U = R × I, R désigne :", ["La résistance","La vitesse","La masse","La température"], 0, "La loi d'Ohm relie la tension U, la résistance R et l'intensité I.", 3, ["lycee","physique","electricite"]),
    q("Lycée : Le rendement d'une machine est toujours :", ["Inférieur ou égal à 1","Supérieur à 10","Négatif","Sans unité et toujours nul"], 0, "Un rendement compare l'énergie utile à l'énergie reçue : il ne peut pas dépasser 1 pour une machine réelle.", 3, ["lycee","physique","thermodynamique"]),
    q("Lycée : L'effet photoélectrique montre que la lumière peut se comporter comme :", ["Des particules appelées photons","Un liquide","Une force de frottement","Un son grave"], 0, "L'effet photoélectrique s'explique avec des photons, des quanta de lumière.", 3, ["lycee","physique","physique_moderne","optique"]),
    ...
    q("CE2 : Quand la Lune cache le Soleil, on observe :", ["Une éclipse de Soleil","Un arc-en-ciel","Un séisme","Une marée noire"], 0, "Une éclipse de Soleil se produit quand la Lune passe devant le Soleil depuis notre point de vue.", 2, ["ce2","astro","phenomenes"]),
    q("Collège : Les galaxies contiennent principalement :", ["Des étoiles, du gaz et des poussières","Des océans liquides","Des pays","Des volcans uniquement"], 0, "Une galaxie regroupe beaucoup d'étoiles avec du gaz et des poussières.", 2, ["college","astro","galaxies"]),
    q("Collège : Un télescope sert surtout à :", ["Observer des objets lointains","Mesurer la pluie","Faire du son","Peser les planètes"], 0, "Un télescope collecte la lumière d'objets lointains pour mieux les observer.", 1, ["college","astro","exploration_spatiale","etoiles"]),
    q("Lycée : Le décalage vers le rouge des galaxies lointaines indique que l'Univers :", ["Est en expansion","Est immobile","Se transforme en glace","Tourne autour de la Terre"], 0, "Le redshift des galaxies lointaines est un indice majeur de l'expansion de l'Univers.", 3, ["lycee","astro","galaxies","phenomenes"]),
    q("Lycée : Dans une étoile comme le Soleil, l'énergie est produite principalement par :", ["Fusion nucléaire","Combustion du bois","Frottement avec l'air","Électricité d'une pile"], 0, "Au cœur du Soleil, des noyaux légers fusionnent et libèrent de l'énergie.", 3, ["lycee","astro","etoiles","physique_moderne"]),
    ...
    q("Collège : En espagnol, '¿Dónde está la biblioteca?' signifie :", ["Où est la bibliothèque ?","Comment tu t'appelles ?","J'ai faim","Il fait froid"], 0, "'Dónde' signifie où, et 'biblioteca' signifie bibliothèque.", 2, ["college","inter","langues","espagnol","phrases","vocab"]),
    q("Collège : En anglais, 'breakfast' désigne :", ["Le petit-déjeuner","Le dîner","Une couleur","Une question"], 0, "'Breakfast' signifie petit-déjeuner.", 1, ["college","inter","langues","anglais","nourriture","vocab"]),
    q("Lycée : En anglais, 'Although it was raining, we went out' exprime :", ["Une concession","Une addition simple","Une obligation","Une comparaison de taille"], 0, "'Although' signifie 'bien que' et introduit une concession.", 3, ["lycee","inter","langues","anglais","phrases"]),
    q("Lycée : En allemand, 'weil' introduit généralement :", ["Une cause","Une couleur","Un nombre","Un animal"], 0, "'Weil' signifie souvent 'parce que' et introduit une cause.", 3, ["lycee","inter","langues","allemand","phrases"]),
  ];
}
