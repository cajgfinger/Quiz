export function technologyQuestions(q) {
  return [
    ...
    q("CE2 : Dans un programme, une boucle sert à :", ["Répéter des instructions","Colorier l'écran uniquement","Supprimer la pile","Mesurer la pluie"], 0, "Une boucle répète une ou plusieurs instructions.", 2, ["ce2","techno","algorithmique"]),
    q("Collège : Une condition en programmation permet de :", ["Choisir une action selon un cas","Toujours répéter sans arrêt","Casser l'ordinateur","Changer la masse"], 0, "Une condition exécute une action si une situation est vraie.", 2, ["college","techno","algorithmique","logique"]),
    ...
    q("Collège : L'opérateur logique ET est vrai si :", ["Les deux conditions sont vraies","Une seule condition est vraie","Toutes les conditions sont fausses","Il n'y a aucune condition"], 0, "A ET B est vrai seulement si A est vrai et B est vrai.", 2, ["college","techno","logique"]),
    ...
    q("Collège : Le phishing cherche surtout à :", ["Voler des informations personnelles","Améliorer la batterie","Dessiner une image","Mesurer la vitesse"], 0, "Le phishing utilise de faux messages pour récupérer des informations sensibles.", 2, ["college","techno","securite_numerique"]),
    ...
    q("Collège : Dans un objet technique, une fonction d'usage répond à la question :", ["À quoi sert-il ?","De quelle couleur est-il ?","Quel âge a-t-il ?","Est-il vivant ?"], 0, "La fonction d'usage explique le service rendu par l'objet.", 2, ["college","techno","objets_techniques"]),
    q("Lycée : Un capteur dans un système automatisé sert à :", ["Mesurer une information de l'environnement","Décorer seulement","Produire du pain","Remplacer toutes les données"], 0, "Un capteur mesure une grandeur et fournit une information au système.", 3, ["lycee","techno","objets_techniques","algorithmique"]),
  ];
}
